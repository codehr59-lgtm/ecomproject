...
<header x-data="{ m: false }">

    {{-- ── ROW 1: Dark green sticky navigation bar ── --}}
    <div class="bg-dark text-white sticky top-0 z-40">
        <div class="max-w-content mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <button type="button"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
                    ...
                    <path x-show="!m" stroke-linecap="round" stroke-linejoin="round"
                          d="M4 6h16M4 12h16M4 18h16"/>
                    <path x-show="m" x-cloak stroke-linecap="round" stroke-linejoin="round"
