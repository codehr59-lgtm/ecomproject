...
return [
     ...
     */
    'notifications' => [
        // Notifications are intentionally empty in dev to avoid mail-config failures.
        // Switch to ['mail'] (and set MAIL_* env vars) in production.
        'notifications' => [
